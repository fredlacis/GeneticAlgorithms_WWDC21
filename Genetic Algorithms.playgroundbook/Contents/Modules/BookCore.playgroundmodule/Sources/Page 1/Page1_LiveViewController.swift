...
public class Page1_LiveViewController: UIViewController, PlaygroundLiveViewMessageHandler, PlaygroundLiveViewSafeAreaContainer {
            
    let swiftUiView = UIHostingController(rootView: Page1_SwiftUIView())
